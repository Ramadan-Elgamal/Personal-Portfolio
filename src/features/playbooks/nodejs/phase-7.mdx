...
export const requireAuth = (
  ...
  if (!authHeader || !authHeader.startsWith("Bearer ")) {
    return next(
      new AppError("Access denied. No valid Bearer token provided.", 401)
    )
  }
